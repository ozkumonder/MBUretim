...
$(function() {
            ...
            buttons: [
                 {
                     ...
                     action: function (e, dt, node, config) {
                         $("#modal_form_vertical").modal({show:true});
                     }
                 },
                {
                    extend: 'copyHtml5',
    ...
    //Production Page DataTable
    $('.datatable-button-html5-columns-production').DataTable({
    ...
    $('.datatable-button-html5-columns-params').DataTable({
